...
public class SearchByPetName extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(SearchByPetName.this));
        searchBar.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                adapter = new ResultAdapter(SearchByPetName.this, mainText, secondText, date, prescription, diagnosis, telephone, SearchByPetName.this);
    ...
    private void storeDataIntoArrays(String searchEnter) {
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                String cursorString = cursor.getString(5).toLowerCase();
                if (cursorString.contains(searchEnter.toLowerCase())) {
                    System.out.println(cursor.getString(9));
                    mainText.add(cursor.getString(5));
                    secondText.add(cursor.getString(9));
